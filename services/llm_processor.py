...
def process_pdf_file(pdf_path):
    try:
        ...
        embeddings = OpenAIEmbeddings()  # OpenAI's embedding model
...
if vector_store:
    ...
    retriever = vector_store.as_retriever(k=20, fetch_k=20)
    ...
    **Structured Output**:
    ...
    # Define the RAG chain for each section
    ...
    with open("extracted_ppm_data.txt", "w") as f:
